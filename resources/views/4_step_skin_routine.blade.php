...
@section('content')
	<div class="col-md-8 offset-2 text-1">4 LANGKAH PERAWATAN RUTIN<br>KECANTIKAN KULIT - MENGAPA ANDA<br>MEMBUTUHKANNYA?</div>
	<div class="col-md-8 offset-2 text-2">Seringkali kita abai merawat kulit dan lebih memprioritaskan hal lainya. Padahal, kulit adalah perisai utama untuk melindungi orangn tubul lainnya dan menjadi hal pertama yang terlihat pada penampilan kita, sehingga perawatan rutin yang tepat dan efektif sangatlah penting. Kunci dari kulit segar dan cantik adalah merawatnya dengan benar sesuai kebutuhannya. Karenanya, berinvestasi pada rutinitas perawatan kulit yang tepat dapat kami jamin merupakan salah satu keputusan terbaik untuk hidup yang berkualitas dan masa depan yang lebih bersinar. Mari simak langkah-lagkahnya:</div>
	
	<div class="row col-md-10 offset-1 step-wrapper">
		<div class="col-md-6">
			<img width="100%" src="{{ asset('img/Pembersih-dan-Toner-1.png') }}">
		</div>
		<div class="col-md-6">
	...
	<div class="row col-md-10 offset-1 step-wrapper">
		<div class="col-md-6" style="z-index: 99;">
			<div class="step-title-1 step-title-3">
				<span class="text-3">LANGKAH 3</span>
				<div class="left-bar"></div>
			</div>
			<div class="col-md-12 step-text-wrapper">
				<div class="text-4 right-text">BOOST</div>
				<div class="text-2 right-text">Patikan penggunaan serum atau esens untuk mendapatkan hasil maksimal!</div>
			</div>
			<div class="col-md-12 step-text-wrapper">
				<div class="text-4 right-text">MENGAPA SERUM?</div>
				<div class="text-2 right-text">Dengan formula terkonsentrasi dan mudah meyerap ke dalam kulit lebih dengan teknologi mutakhir, untuk memaksimalkan hasil dari krim pagi dan krim malam Anda.</div>
			</div>
		</div>
